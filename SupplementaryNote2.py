...
# python code to run the coalescent simulations under the demographic model shown in Supplementary Figure 4B #
...
t_AFR1_split = int(95800 / generation_time)
t_AFR3_split = int(80000 / generation_time)
t_OOA_split = t_AFR3_split - 1
t_BEA_split = int(79800 / generation_time)
t_WEA_EEA_split = int(50400 / generation_time)
t_WEA2_split = int(40000 / generation_time)

# this parameter controls how many years before WEC2/WEA2 did WEC/WEA leave the hub #
# N is 43000, 42000 and 41000 in the simulations whose results are shown in Supplementary figure D, E and F respectively #
t_WEA_split = int(N / generation_time)
#
t_UST_sample = int(44377 / generation_time)
t_UST_split = int(51500 / generation_time)
#
...
# admixtures #
t_BEA2WEA = int(33700 / generation_time)
...
# Rescale Gravel et al. 2011 parameters #
# Ne_final_EAS = 86674.78397785178 | Ne_0 = 550 #
# Ne_final_EUR = 40915.07868289492 | Ne_0 = 1032 #
# r = math.log(Ne/Ne_0)/t #
r_WEA = 0.00260
r_EEA = 0.00291
r_BEA = 0.00160 # will take them to the same Ne as OOA by the time they admix with WEC

Ne_WEA = Ne_WEA_0 / math.exp(-r_WEA * t_WEA_split)
...
demography.add_population(name = "AMH", initial_size = Ne_AMH, default_sampling_time = t_AMH_sample)
...
demography.add_population(name = "HUB_0", initial_size = Ne_OOA)
...
demography.add_population_split(time = t_UST_split, derived = ["UST", "HUB"], ancestral ="HUB_0")
demography.add_population_split(time = t_BEA_split, derived = ["HUB_0", "BEA"], ancestral ="OOA")
demography.add_mass_migration(time = t_OOA_split, source ="OOA", dest ="AFR3", proportion = 1)
demography.add_mass_migration(time = t_AFR3_split, source ="AFR3", dest ="AFR1", proportion = 1)
